            ...
            <div class="row d-flex justify-content-center">
                @forelse ($books as $book)
                    <div class='post-module'>
                        <div class='thumbnail'>
                            <img onclick="location.href='{{ route('detail-book', $book->judul) }}';"
                                src='{{ Storage::url($book->photo) }}'>
                        </div>
                        <div class='post-content'>
                            <div class='category'> <i class='fa fa-book'></i>
                            ...
                            <div class='post-meta'>
                                ...
                                <span class='comments'>
                                    ...
                                    <a href='{{ route('detail-training', $book->judul) }}'>Lihat Detail ...</a>
                                </span>
                            </div>
                        </div>
                    </div>
